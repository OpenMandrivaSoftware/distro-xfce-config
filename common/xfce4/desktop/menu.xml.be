...
<xfdesktop-menu>
	...
	<title name="Мэню Xfce" icon="/usr/share/icons/Tango/scalable/apps/mandriva.svg"/>
	...
	<app name="Гартач сеціва" cmd="exo-open --launch WebBrowser" icon="gnome-globe"/>
    ...
    <app name="Пра Xfce" cmd="xfce4-about" icon="info"/>
    <!--
