...
<xfdesktop-menu>
	...
	<title name="Xfce Menu" icon="/usr/share/icons/Tango/scalable/apps/mandriva.svg"/>
	...
	<app name="Web Browser" cmd="exo-open --launch WebBrowser" icon="gnome-globe"/>
    ...
    <app name="Xfce Info" cmd="xfce4-about" icon="info"/>
    <!--
