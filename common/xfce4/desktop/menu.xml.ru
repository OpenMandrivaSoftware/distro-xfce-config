...
<xfdesktop-menu>
	...
	<title name="Меню рабочего стола" icon="/usr/share/icons/Tango/scalable/apps/mandriva.svg"/>
	...
	<app name="Интернет-браузер" cmd="exo-open --launch WebBrowser" icon="gnome-globe"/>
    ...
    <app name="Об Xfce" cmd="xfce4-about" icon="info"/>
    <!--
