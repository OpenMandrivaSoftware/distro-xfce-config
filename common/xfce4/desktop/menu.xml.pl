...
<xfdesktop-menu>
	...
	<title name="Menu Pulpitu" icon="/usr/share/icons/Tango/scalable/apps/mandriva.svg"/>
	...
	<app name="Przeglądarka internetowa" cmd="exo-open --launch WebBrowser" icon="gnome-globe"/>
    ...
    <app name="O Xfce" cmd="xfce4-about" icon="info"/>
    <!--
