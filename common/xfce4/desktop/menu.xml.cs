...
<xfdesktop-menu>
	...
	<title name="Hlavní nabídka" icon="/usr/share/icons/Tango/scalable/apps/mandriva.svg"/>
	...
	<app name="Webový prohlížeč" cmd="exo-open --launch WebBrowser" icon="gnome-globe"/>
    ...
    <app name="O prostředí Xfce" cmd="xfce4-about" icon="info"/>
    <!--
